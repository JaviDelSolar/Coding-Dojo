from login_registro_app.configuracion.mysqlconnection import connectToMySQL
...
class Usuario:
    ...
    @staticmethod  # Metodo estatico para la validacion de regitro
...
# Acá se realizo todas las validaciones del registro del "Registro" que registramos en la pestaña login_registro.html